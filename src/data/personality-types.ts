...
export const dimensionOrder: DimensionCode[] = [
  'S1', 'S2', 'S3', 'E1', 'E2', 'E3',
...
// ── 15 维度各等级解读 ──
export const dimensionExplanations: Record<DimensionCode, DimensionExplanation> = {
  S1: {
...
// ── 27 种人格类型库 ──
export const typeLibrary: Record<string, IMSBPersonalityType> = {
  CTRL: {
    code: 'CTRL',
    cn: '拿捏者',
    intro: '怎么样，被我拿捏了吧？',
...
// ── 25 种常规人格的 pattern ──
export const normalTypes: NormalTypePattern[] = [
